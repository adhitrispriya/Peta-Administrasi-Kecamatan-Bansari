...
map.getView().fit([12244386.899223, -817075.991298, 12248741.562145, -813174.213150], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Batas Administrasi Kecamatan Bansari, Kabupaten Temanggung, Provinsi Jawa Tengah</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (1563 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta Batas Administrasi Kecamatan Bansari, Kabupaten Temanggung disusun untuk menyajikan informasi spasial mengenai batas wilayah administrasi Kecamatan Bansari secara akurat dan informatif. Peta ini bertujuan untuk mendukung kegiatan perencanaan wilayah, pengelolaan sumber daya, analisis kewilayahan, serta penyediaan informasi geospasial bagi berbagai kepentingan pemerintahan, pendidikan, dan penelitian. Penyusunan peta dilakukan melalui pengolahan data spasial menggunakan perangkat lunak Sistem Informasi Geografis (SIG) sehingga menghasilkan representasi spasial yang mampu menggambarkan batas administrasi Kecamatan Bansari beserta posisi geografisnya secara jelas.<br />Peta ini diharapkan dapat menjadi sumber informasi geospasial yang dapat digunakan sebagai dasar dalam kegiatan analisis kewilayahan dan pengambilan keputusan di wilayah Kecamatan Bansari, Kabupaten Temanggung.<br />Metadata Peta<br />Judul Peta : Peta Batas Administrasi Kecamatan Bansari Kabupaten Temanggung <br />Wilayah Pemetaan : Kecamatan Bansari, Kabupaten Temanggung, Provinsi Jawa Tengah <br />Sistem Koordinat : Sistem Koordinat Geografis (Geographic Coordinate System/GCS) <br />Datum : WGS 1984 <br />Satuan Koordinat : Derajat (Decimal Degrees) <br />Jenis Grid : Gratikul (Graticule) <br />Metode Grid : Measured Grid <br />Format Data : Shapefile (.shp) <br />Tahun Pembuatan Peta : 2026 <br />Perangkat Lunak Pengolahan : Sistem Informasi Geografis (SIG) <br />Sumber Peta<br />Badan Informasi Geospasial (BIG), Data Batas Administrasi Indonesia Skala 1:50.000 Tahun 2025. <br />Hasil pengolahan dan penyusunan peta oleh penulis, Tahun 2026.';
            }
